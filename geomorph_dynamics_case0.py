...
# fluvial_freq=40000 #how often the humid period occurs
...
while time < total_model_time:
      ...
      if accumulate >= mg.dx:
          ss_fault(grid=mg, fault_loc_y=int(mg.number_of_node_rows / 3.), total_slip=total_slip,
      ...
      if time%5000 == 0:
          ...
          # plt.show()
          plt.savefig('output_model_run/case_0/topo_%s_yrs.png' % (int(time+dt)), dpi=300, facecolor='white')
          plt.clf()
...
# plt.show()
plt.savefig('output_model_run/case_0/topo_%s_yrs.png' % (int(total_model_time)), dpi=300, facecolor='white')
mg.save('output_model_run/case_0/finaltopo.asc')
